 ...
 */
public class OzoneYear extends Distributed {
...
//
                        ...
                        for (int i = 6; i < tokens.length; ++i) {
                            ...
                            if (lon >= mycoord.x1 && lon < mycoord.x2) {
                                ...
                                System.out.format("%4d%02d%02d  %.1f %.1f %d%n",values[0],values[1],values[2],coords[0],coords[1],values[3]);
                                result=String.format("%4d%02d%02d  %.1f %.1f %d%n",values[0],values[1],values[2],coords[0],coords[1],values[3]);
